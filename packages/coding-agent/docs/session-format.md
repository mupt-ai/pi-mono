...
Source on GitHub ([pi-mono](https://github.com/earendil-works/pi)):
...
For TypeScript definitions in your project, inspect `node_modules/@mupt-ai/pi-coding-agent/dist/` and `node_modules/@earendil-works/pi-ai/dist/`.
