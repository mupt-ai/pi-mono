...
Reusable web UI components for building AI chat interfaces powered by [@mupt-ai/pi-ai](../ai) and [@mupt-ai/pi-agent-core](../agent).
...
```bash
npm install @mupt-ai/pi-web-ui @mupt-ai/pi-agent-core @mupt-ai/pi-ai
```
...
import '@mupt-ai/pi-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@mupt-ai/pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@mupt-ai/pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@mupt-ai/pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@mupt-ai/pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@mupt-ai/pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@mupt-ai/pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@mupt-ai/pi-web-ui';
...
```typescript
import { SessionListDialog } from '@mupt-ai/pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@mupt-ai/pi-web-ui';
...
```typescript
import { ModelSelector } from '@mupt-ai/pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@mupt-ai/pi-web-ui';
