...
Reusable web UI components for building AI chat interfaces powered by [@mariozechner/pi-ai](../ai) and [@mupt-ai/pi-agent-core](../agent).
...
```bash
npm install @mariozechner/pi-web-ui @mupt-ai/pi-agent-core @mariozechner/pi-ai
```
